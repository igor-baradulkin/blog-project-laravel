        ...
        <div class="w-3/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="repeat_password" id="repeat_password" placeholder="Repeat your password" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('repeat_password') border-red-500 @enderror" value="">
